...
export default class EmbeddingManager {
  ...
  private readonly providerApiKeyMap: Record<EmbeddingModelProviders, () => string> = {
    [EmbeddingModelProviders.COPILOT_PLUS]: () => getSettings().openAIApiKey,
    [EmbeddingModelProviders.COPILOT_PLUS_JINA]: () => getSettings().openAIApiKey,
  ...
  private async getEmbeddingConfig(customModel: CustomModel): Promise<any> {
    ...
    const providerConfig: {
      ...
      [EmbeddingModelProviders.COPILOT_PLUS]: {
        ...
        configuration: {
          baseURL: customModel.baseUrl || settings.openAIEmbeddingProxyBaseUrl,
